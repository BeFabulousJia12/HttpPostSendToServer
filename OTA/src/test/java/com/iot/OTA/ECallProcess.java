...
public class ECallProcess extends HttpServlet{
	    ...
	    public void doPost(HttpServletRequest request, HttpServletResponse response)  
	    	...
	    	try {
	    		...
	    		createDataBytes.writedata("Ecall Post body to the thirdParty：" + afterEncode + "\r\n");
	    		if(jsonparse.getString("callType").contains("E-CALL") && jsonparse.getString("vin").equals("RHHHQ678900000000"))
				{
