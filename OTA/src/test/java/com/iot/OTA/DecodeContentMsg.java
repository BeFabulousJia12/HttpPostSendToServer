...
public class DecodeContentMsg {
		...
		public static String AESEncrypt(String bodymsg) throws Exception {
			...
			*/
			...
			// 加密
			String enString = DecodeContentMsg.Encrypt(contentbytes, cKey, cKey);
		...
		public static String AESDecode(String bodymsg) throws Exception {
			...
			*/
			...
			String DeString = DecodeContentMsg.Decrypt(bodymsg, cKey, cKey);
			System.out.println("解密后的字串是：" + DeString);
			long lUseTime = System.currentTimeMillis() - lStart;
			System.out.println("解密耗时：" + lUseTime + "毫秒");
			DeString = DeString.substring(18, DeString.length() - 32 );
			System.out.println("解密后截取的内容：" + DeString);
			return DeString;
